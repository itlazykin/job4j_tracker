...
class FunctionCalculatorTest {
    ...
    @Test
    void whenQuadraticFunctionResult() {
        FunctionCalculator functionCalculator = new FunctionCalculator();
        List<Double> result = functionCalculator.diapason(5, 8, x -> x * x);
    ...
    void whenExponentialFunctionResult() {
        FunctionCalculator functionCalculator = new FunctionCalculator();
        List<Double> result = functionCalculator.diapason(5, 8, x -> Math.pow(x, x));
